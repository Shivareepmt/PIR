...
public class TextBufferWindow extends Window {
    ...
    private class _CommandView extends AppCompatEditText {
    ...
    private class _PromptView extends AppCompatTextView {
    ...
    private class _View extends AppCompatEditText {
    ...
    boolean styleDistinguish(int style1, int style2) {
        ...
        @SuppressLint("ResourceType") TypedArray ta1 = mContext.obtainStyledAttributes(res1, fields);
        @SuppressLint("ResourceType") TypedArray ta2 = mContext.obtainStyledAttributes(res2, fields);
